...
Source0  : https://cpan.metacpan.org/authors/id/B/BD/BDFOY/Business-ISMN-1.131.tar.gz
...
tar -xf %{SOURCE1}
cd ..
%setup -q -n Business-ISMN-1.131
mkdir -p %{_topdir}/BUILD/Business-ISMN-1.131/deblicense/
mv %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Business-ISMN-1.131/deblicense/
